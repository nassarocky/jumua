...
const FIELDS: FieldConfig[] = [
  { name: 'phone', label: 'phone', required: true, keyboardType: 'phone-pad' },
  { name: 'first_name', label: 'first-name', required: false },
  { name: 'last_name', label: 'last-name', required: false },
  { name: 'address_1', label: 'address', required: false },
  { name: 'city', label: 'city', required: false },
  { name: 'country_code', label: 'country-code', required: false },
];
