...
const AnimatedCartButton = ({
  ...
  const isOutOfStock = hasSelectedAllOptions && !inStock;

  return (
    <Animated.View className="p-4 flex-row items-center" style={[rowStyles]}>
      ...
      <View className="flex-1 flex-row gap-2">
        <View className="flex-1">
          <Button
            variant="secondary"
            title={isOutOfStock ? l10n.getString('out-of-stock') : l10n.getString('add-to-cart')}
